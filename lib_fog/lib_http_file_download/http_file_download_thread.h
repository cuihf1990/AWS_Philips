...
#define HTTP_DOWNLOAD_HEAD_MAX_LEN                  (1536)

#define FILE_DOWNLOAD_SSL_CONNECT_TIMEOUT           (6000)

#define HTTP_SEND_TIME_OUT                          (5000)
#define HTTP_RECV_TIME_OUT                          (6000)
...
#define HTTP_DNS_RETRY_MAX_TIMES                    (2)
...
typedef enum {
    ...
    HTTP_FILE_DOWNLOAD_CONTROL_STATE_RUN,
